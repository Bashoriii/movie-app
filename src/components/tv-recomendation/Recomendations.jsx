  ...
  useEffect(() => {
    const recomendations = async () => {
      try {
        ...
        console.log('Cant request recomend tv', error);
      }
    };
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="recomended-tv-container section">
                ...
                <SwiperSlide key={recomend.id} className="card-slider">
                  <Link to={`/movie/${id}`} className="card">
                    ...
                    <div className="title-and-year">
                      <p className="title">{recomend.name}</p>
                      <span>
                        {new Date(recomend.first_air_date).getFullYear()}
                      </span>
                    </div>
                  </Link>
                </SwiperSlide>
